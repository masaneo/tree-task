...
var collapse = document.getElementsByClassName('collapse-button');

for (var i = 0; i < collapse.length; i++) {
  collapse[i].addEventListener("click", function () {
    this.classList.toggle("activeColl");
    var content = this.parentNode.parentNode.children;
...
var collapseDivs = document.getElementsByClassName('collapse');

for (var _i = 0; _i < collapseDivs.length; _i++) {
  var content = collapseDivs[_i].children;
